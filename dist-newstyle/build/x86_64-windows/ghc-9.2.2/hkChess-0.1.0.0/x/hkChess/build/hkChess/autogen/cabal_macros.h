...
/* package hkChess-0.1.0.0 */
#ifndef VERSION_hkChess
#define VERSION_hkChess "0.1.0.0"
#endif /* VERSION_hkChess */
#ifndef MIN_VERSION_hkChess
#define MIN_VERSION_hkChess(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hkChess */
...
#define CURRENT_COMPONENT_ID "hkChess-0.1.0.0-inplace-hkChess"
